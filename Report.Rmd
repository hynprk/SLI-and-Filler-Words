...
```{r, fig.cap = "Standardized mean difference of variables before and after nearest neighbour matching"}
...
$$
y^f = -4.3641 + 0.3592 x_1 + 0.0661 x_2 + 0.9047 x_3 + 0.2254 x_4 -0.1039 x_5 + 1.5162 x_6
$$
...
|       This paper includes some limitations coming from the dataset and the propensity score matching technique. which can be further discussed in the upcoming subsections.
